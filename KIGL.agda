...
-- To-do:
--   * Combinatory logic for Hilbert system
--   * Translation between Hilbert system and Kripke-style deduction system
--   * 
module KIGL where
...
-- External gnum, reduced manually
gnum′ : Ψ , Γ ⊢ □ A
        --------------
      → Ψ , Γ , ∅ ⊢ □ A
gnum′ M = π₁ ⌊ mfix ⟨ ⌈ π₂ ⌊ # 0 ⌋ ⌉ , ⌊ M ⌋ ⟩ ⌋
